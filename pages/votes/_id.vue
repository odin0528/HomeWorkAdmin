    ...
    <b-card no-body class="mb-0">
      ...
      <b-container fluid>
        <b-row class="product_list_header">
          <b-col cols="4">{{ $t('candidate_title') }}</b-col>
          <b-col cols="4">{{ $t('candidate_photo') }}</b-col>
          <b-col cols="4">{{ $t('candidate_vote') }}</b-col>
        </b-row>
        <b-row
        ...
        >
          <b-col cols="4" class="text-left">
            <b-link :to="`/votes/logs/${candidate.id}`">
              {{ candidate.title }}
            </b-link>
          </b-col>
          <b-col cols="4"><img :src="$config.imageUrl + candidate.photo" width="20%" /></b-col>
          <b-col cols="4">{{ candidate.vote }}</b-col>
          <hr />
        </b-row>
      </b-container>
      <div class="mx-2 mb-2">
...
export default {
  ...
  methods: {
    voteFetch() {
      ...
      this.$axios
        .$post(`/api/votes/${voteId}/candidate`, {
